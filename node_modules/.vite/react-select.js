...
var LiveRegion = function LiveRegion2(props) {
  ...
  var ScreenReaderText = jsx(import_react6.default.Fragment, null, jsx("span", {
    id: "aria-selection"
  }, ariaSelected), jsx("span", {
    id: "aria-context"
  }, ariaContext));
  var isInitialFocus = (ariaSelection === null || ariaSelection === void 0 ? void 0 : ariaSelection.action) === "initial-input-focus";
  return jsx(import_react6.default.Fragment, null, jsx(A11yText, {
    id
...
function ScrollManager(_ref3) {
  ...
  return jsx(import_react6.default.Fragment, null, lockEnabled && jsx("div", {
...
var Select = function(_Component) {
  ...
  _createClass(Select2, [{
    ...
    value: function renderInput() {
      ...
      if (!isSearchable) {
        return import_react6.default.createElement(DummyInput, _extends({
          id,
      ...
      return import_react6.default.createElement(Input3, _extends({}, commonProps, {
        autoCapitalize: "none",
        autoComplete: "off",
        autoCorrect: "off",
        id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : import_react6.default.createElement(Placeholder3, _extends({}, commonProps, {
          key: "placeholder",
          isDisabled,
          isFocused,
          innerProps: {
      ...
      if (isMulti) {
        return selectValue.map(function(opt, index) {
          ...
          return import_react6.default.createElement(MultiValue3, _extends({}, commonProps, {
            components: {
      ...
      return import_react6.default.createElement(SingleValue3, _extends({}, commonProps, {
        data: singleValue,
        isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return import_react6.default.createElement(ClearIndicator3, _extends({}, commonProps, {
        innerProps,
        isFocused
      }));
    }
    ...
    value: function renderLoadingIndicator() {
      ...
      return import_react6.default.createElement(LoadingIndicator3, _extends({}, commonProps, {
        innerProps,
        isDisabled,
        isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return import_react6.default.createElement(IndicatorSeparator3, _extends({}, commonProps, {
        isDisabled,
        isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return import_react6.default.createElement(DropdownIndicator3, _extends({}, commonProps, {
        innerProps,
        isDisabled,
        isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render2(props, id) {
        ...
        return import_react6.default.createElement(Option3, _extends({}, commonProps, {
          innerProps,
          data,
          isDisabled,
          isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function(item) {
          if (item.type === "group") {
            ...
            return import_react6.default.createElement(Group3, _extends({}, commonProps, {
              key: groupId,
              data: _data,
              options: options2,
        ...
        if (message === null)
          return null;
        menuUI = import_react6.default.createElement(LoadingMessage3, commonProps, message);
      } else {
        ...
        if (_message === null)
          return null;
        menuUI = import_react6.default.createElement(NoOptionsMessage3, commonProps, _message);
      }
      ...
      var menuElement = import_react6.default.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function(_ref4) {
        var ref = _ref4.ref, _ref4$placerProps = _ref4.placerProps, placement = _ref4$placerProps.placement, maxHeight = _ref4$placerProps.maxHeight;
        return import_react6.default.createElement(Menu3, _extends({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          isLoading,
          placement
        }), import_react6.default.createElement(ScrollManager, {
          captureEnabled: captureMenuScroll,
          onTopArrive: onMenuScrollToTop,
          onBottomArrive: onMenuScrollToBottom,
          lockEnabled: menuShouldBlockScroll
        }, function(scrollTargetRef) {
          return import_react6.default.createElement(MenuList3, _extends({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === "fixed" ? import_react6.default.createElement(MenuPortal2, _extends({}, commonProps, {
    ...
    value: function renderFormField() {
      ...
      if (isMulti) {
        if (delimiter2) {
          ...
          return import_react6.default.createElement("div", null, input);
        }
      } else {
    ...
    value: function renderLiveRegion() {
      ...
      return import_react6.default.createElement(LiveRegion, _extends({}, commonProps, {
    ...
    value: function render() {
      ...
      return import_react6.default.createElement(SelectContainer3, _extends({}, commonProps, {
        className,
        innerProps: {
          id,
        ...
        isDisabled,
        isFocused
      }), this.renderLiveRegion(), import_react6.default.createElement(Control3, _extends({}, commonProps, {
        ...
        isFocused,
        menuIsOpen
      }), import_react6.default.createElement(ValueContainer3, _extends({}, commonProps, {
        isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), import_react6.default.createElement(IndicatorsContainer3, _extends({}, commonProps, {
        isDisabled
...
var StateManagedSelect = import_react8.default.forwardRef(function(props, ref) {
  var baseSelectProps = useStateManager(props);
  return import_react8.default.createElement(Select, _extends({
    ref
  }, baseSelectProps));
});
var NonceProvider = function(_Component) {
  ...
  _createClass(NonceProvider2, [{
    ...
    value: function render() {
      ...
      return import_react8.default.createElement(CacheProvider, {
        value: emotionCache
      }, this.props.children);
    }
  }]);
